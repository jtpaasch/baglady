...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.valid_pattern'
        db.add_column(u'baglady_category', 'valid_pattern',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.valid_pattern'
        db.delete_column(u'baglady_category', 'valid_pattern')
